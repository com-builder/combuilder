...
class {{Name}}View{{Item}}s extends BaseView
{
     ...
     *
     * @param   object  $row  An object (usually from the database) containing
     *                        an identification number (`id`) and name (`name`).
     *
     * @return  string        A fully rendered anchor tag for direct placement
     *                        in a template.
     */
